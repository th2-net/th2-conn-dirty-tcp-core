...
object BasicManglerFactory : IManglerFactory {
    override val name: String = "basic"
    override val settings: Class<out IManglerSettings> = BasicManglerSettings::class.java
    override fun create(context: IManglerContext): IMangler = BasicMangler(context.settings as BasicManglerSettings)
    data class BasicManglerSettings(val rules: List<Rule>) : IManglerSettings
}
